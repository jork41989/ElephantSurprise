...
export default {
  ...
  `,
  ASSIGN_SANTA: gql`
    mutation assignSanta($owner_id: ID!, $exchange_id: ID!, $santa_id: ID!) {
      assignSanta(owner_id: $owner_id, exchange_id: $exchange_id, santa_id: $santa_id) {
        _id
        owner{
          _id
          name
